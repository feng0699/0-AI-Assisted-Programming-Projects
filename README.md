...
* Build functional prototypes with minimal setup

Each project here represents hands-on practice using AI to assist in coding, debugging, and problem-solving.
...
* Build small to medium-sized projects efficiently
* Showcase practical use cases of AI in software development
...
│── notes.md         # My learnings / AI prompts used (optional)
```
...
4. Run the code based on the instructions provided
...
* AI is powerful, but still requires human validation
* Debugging is still an essential skill even with AI
...
* Explore advanced AI integrations (APIs, automation, etc.)
